...
require (
	github.com/Nextc3/notifica-model v0.0.0-20231008220412-6da935533cbe
	...
	github.com/hyperledger/fabric-samples/asset-transfer-basic/chaincode-go v0.0.0-20230929175748-62f304a98f35
